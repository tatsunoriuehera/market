...
class ChartController extends Controller
{
    ...
    public function result(Request $request){
      ...
      //SQLの結果を連想配列で変数に代入
      $dates = DB::select('select distinct date , total_quantity from all_markets where name = :name and date between :s_date and :e_date and total_quantity > 0 order by date ',$param);
      $namelist = DB::select('select distinct name from names ');
      //$dates=['2021-04-01','2021-04-02','2021-04-03'];
